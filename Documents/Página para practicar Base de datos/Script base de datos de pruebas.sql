CREATE DATABASE pruebas_baseProyecto;

USE pruebas_baseProyecto;
...
INSERT INTO `domicilio` VALUES VALUES (1,'Calle falsa',4,NULL,'4000','San Miguel de Tucumán','Tucumán','Argentina',001),(2,'Calle Falsa',1964,NULL,'4000','San Miguel de Tucumán','Tucumán','Argentina',002),(3,'Calle Falsa',1,NULL,'4103','Tafí Viejo','Tucumán','Argentina',003);
...
CREATE TABLE IF NOT EXISTS `pruebas_baseProyecto`.`cursos_de_jerarquia` (
  ...
  PRIMARY KEY (`id_cursos_de_jerarquia`, `legajo_personal_id_legajo_personal`),
    ...
    REFERENCES `pruebas_baseProyecto`.`legajo_personal` (`id_legajo_personal`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION);

CREATE TABLE IF NOT EXISTS `pruebas_baseProyecto`.`altas_ascensos_bajas` (
...
CREATE TABLE IF NOT EXISTS `pruebas_baseProyecto`.`funciones_y_cargos` (
...
CREATE TABLE IF NOT EXISTS `pruebas_baseProyecto`.`nacio_en` (
...
CREATE TABLE IF NOT EXISTS `pruebas_baseProyecto`.`examen_medico` (
...
CREATE TABLE IF NOT EXISTS `pruebas_baseProyecto`.`antecedentes_personales` (
...
CREATE TABLE IF NOT EXISTS `pruebas_baseProyecto`.`tension_arterial` (
...
CREATE TABLE IF NOT EXISTS `pruebas_baseProyecto`.`cabeza_sentidos` (
...
CREATE TABLE IF NOT EXISTS `pruebas_baseProyecto`.`torax` (
...
CREATE TABLE IF NOT EXISTS `pruebas_baseProyecto`.`abdomen` (
...
CREATE TABLE IF NOT EXISTS `pruebas_baseProyecto`.`evaluacion` (
...
CREATE TABLE IF NOT EXISTS `pruebas_baseProyecto`.`antecedentes_heredoFamiliares` (
...
CREATE TABLE usuarios (id INT NOT NULL AUTO_INCREMENT, usuarios VARCHAR(20) NULL, passw VARCHAR(250) NULL, PRIMARY KEY (id));

INSERT INTO usuarios (usuario, passw) VALUES ('pruebas1', 'Pruebas1'), ('pruebas2', 'Pruebas2'), ('pruebas3', 'Pruebas3');
