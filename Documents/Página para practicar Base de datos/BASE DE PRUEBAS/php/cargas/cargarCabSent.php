...
if($consultaId) {
    ...
    $sql = "INSERT INTO cabeza_sentidos(oido, vista, tacto, olfato, gusto, legajo_personal_id_legajo_personal) VALUES ('$oido', '$vista', '$tacto','$olfato', '$gusto', '$idLegajoPersonal')";
